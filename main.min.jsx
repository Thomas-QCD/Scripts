// Illustrator ExtendScript - Built with esbuild
  ...
  function createMainDialog() {
    ...
    var scaleGroup = layerStylingGroup.add("group");
    scaleGroup.orientation = "row";
    scaleGroup.alignChildren = ["left", "center"];
    scaleGroup.spacing = 8;
    var scaleDropdown = scaleGroup.add("dropdownlist", void 0, [
      "Full scale",
      "10th scale",
      "Half scale",
      "Quarter scale"
    ]);
    scaleDropdown.preferredSize.width = 180;
    ...
    var btnSetScale = scaleGroup.add("button", void 0, "Set Scale");
    btnSetScale.preferredSize.width = 80;
    btnSetScale.preferredSize.height = 24;
    btnSetScale.onClick = function() {
      try {
        var scaleText = scaleDropdown.selection ? scaleDropdown.selection.text : "Full scale";
        saveScaleToXMP(scaleText);
      } catch (e) {
        alert("Error setting scale: " + e);
      }
    };
